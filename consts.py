...
TK_KEY_LEFT         = [81, 37]
TK_KEY_RIGHT        = [68, 39]
TK_KEY_ROT_CW90     = [83, 40]
TK_KEY_ROT_NCW90    = [90, 38]
TK_KEY_ACCELERATE   = [32]
...
# pivots and rotation system should be reviewed, it will not work as it is
PIECE_PIVOT         = { BOA_VIRT_PIECE_I: (2, 2),
                        BOA_VIRT_PIECE_O: (2, 1),
                        BOA_VIRT_PIECE_T: (1.5, 1.5),
                        BOA_VIRT_PIECE_L: (1.5, 0.5),
                        BOA_VIRT_PIECE_J: (1.5, 0.5),
                        BOA_VIRT_PIECE_Z: (1.5, 0.5),
                        BOA_VIRT_PIECE_S: (1.5, 0.5) }
